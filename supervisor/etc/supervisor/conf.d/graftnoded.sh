...
mkdir -p $HOME/.graft/testnet && rm -r $HOME/.graft/testnet/lmdb && mkdir -p $HOME/.graft/testnet/lmdb && cd ~/.graft/testnet/lmdb && wget https://rta.graft.observer/lmdb/data.mdb && \
